...
PImage cancha, inicio, rojo, azul, pelota, golImg;
...
void draw() {
  ...
  if ( estado.equals( "inicio" ) ) {
    ...
    reiniciarAzul = false; 
    reiniciarRojo = false;
    if ( p1.getX() >= width/2-150 && p1.getY() > height/2-50 && p1.getY() < height/2+50 || p2.getX() <= width/2+150 && p2.getY() > height/2-50 && p2.getY() < height/2+50 ) { 
      estado = "juego";
    }
  }
...
void contactStarted( FContact c ) {
  ...
  if ( (f1.getName() == "ball" && f2.getName() == "arco1" || f1.getName() == "arco1" && f2.getName() == "ball") && !festejo ) {
    golA ++;
    timeGol = true;
    festejo = true;      
  } 
  //Contacto pelota - arco2 
  if ( (f1.getName() == "ball" && f2.getName() == "arco2" || f1.getName() == "arco2" && f2.getName() == "ball") && !festejo ) {
    golR ++;
    timeGol = true;
    festejo = true;    
  } 
  //Contacto pelota - box1 
  if ( (f1.getName() == "ball" && f2.getName() == "box1" || f1.getName() == "box1" && f2.getName() == "ball") && !obstaculos && !power ) {
    obstaculos = true;
    power = true;
  }
